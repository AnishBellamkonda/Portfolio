  ...
  const skillCategories = [
    {
      ...
      skills: ["Python", "Java", "JavaScript", "TypeScript", "C++", "C#", "C", "GoLang"],
      icon: <Code className="w-8 h-8 text-primary" />
    },
    {
      title: "Frontend Technologies",
      skills: ["React.js", "React Native", "Vue.js", "Angular", "Next.js", "HTML5", "CSS3", "Tailwind CSS", "Bootstrap"],
      icon: <Monitor className="w-8 h-8 text-primary" />
    },
    {
      title: "Backend Technologies",
      skills: ["Node.js", "Express.js", "Spring", "Spring Boot", "Django", "PHP", "Ruby on Rails", ".NET Core", "API Development"],
      icon: <Server className="w-8 h-8 text-primary" />
    },
    {
      title: "Cloud & DevOps",
      skills: ["AWS", "Docker", "Kubernetes", "CI/CD", "Git","Jenkins", " Terraform"],
      icon: <Cloud className="w-8 h-8 text-primary" />
    },
    {
      title: "Databases",
      skills: ["MongoDB", "PostgreSQL", "MySQL", "Redis", "Elasticsearch", "Cassandra", "SQL Server"],
      icon: <Database className="w-8 h-8 text-primary" />
    },
    {
      title: "Artificial Intelligence & Machine Learning",
      skills: ["TensorFlow", "PyTorch", "Scikit-learn", "OpenAI", " Deep Learning", "Computer Vision",  "Natural Language Processing"],
